...
using Bussiness.ValidationRules.FluentValidition;
...
namespace Bussiness.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        public IResult Add(Product product)
        {
            ...
            IResult result = BusinessRules.Run(CheckIfProductCountOfCategory(product.CategoryId), CheckIfPrdouctNameExists(product.ProductName),
        ...
        private IResult CheckIfPrdouctNameExists(string productName)
        {
